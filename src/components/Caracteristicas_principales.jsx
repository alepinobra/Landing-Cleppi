        ...
        <div className="bg-color_fondo p-8 flex flex-col items-center justify-center gap-2">
            ...
            <section className='bg-color_fondo grid grid-cols-1 md:grid-cols-9'>       
                <div className='flex flex-col md:col-span-3 flex items-center justify-center p-8 xl:p-20 gap-3 animate__animated animate__fadeIn'>
                    ...
                    <h1 className="text-3xl text-primary font-bold font-medium">Cotizar</h1>
                ...
                <div className='flex flex-col md:col-span-3 flex items-center justify-center p-8 xl:p-20 gap-3 animate__animated animate__fadeIn'>
                    ...
                    <h1 className="text-3xl text-primary font-bold font-medium">Administrar</h1>
                    <h1 className="text-1xl text-primary font-ligth text-center">Ahorra tiempo con las recomendaciones para dedicarlo a otras areas 
                        del negocio.
                    </h1>
                </div>
                ...
                <div className='flex flex-col md:col-span-3 flex items-center justify-center p-8 xl:p-20 gap-3 animate__animated animate__fadeIn'>   
                    ...
                    <h1 className="text-3xl text-primary font-bold font-medium">Comprar directo</h1>
                    {/* referencia para el header */}
                    <h1 id="como" className="text-1xl text-primary font-ligth text-center">Compra directamente con laboratorios para lograr mejores precios.
                    </h1>
                </div>
